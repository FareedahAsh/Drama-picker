...
- change buttons to show all four options
- create lists for the respected buttons
- import website to respected button
- create code to randomize drama pick
- change output display type (Instead of showing vertically, should be horizontal)